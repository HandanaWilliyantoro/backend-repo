...
exports.claimToken = exports.getUsers = exports.updateUsers = void 0;
...
const claimToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _d;
    const idToken = (_d = req.headers.authorization) === null || _d === void 0 ? void 0 : _d.split('Bearer ')[1];
    if (!idToken) {
        res.status(401).json(new ApiError_1.default(401, 'Access token not found'));
    }
    try {
        const claimedToken = yield (0, userCollection_1.claim)(idToken);
